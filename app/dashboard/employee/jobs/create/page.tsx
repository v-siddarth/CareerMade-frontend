                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            placeholder="Ex. 1"
                            min="1"
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                          />
                        </div>
                      </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        {selectedScreeningPreset === "__other__" && (
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 mb-3">
                          <input
                            ...
                            placeholder={selectedScreeningPreset === "__other__" ? "Type your custom question here..." : "Ex. Do you have ICU experience?"}
                            className={`flex-1 px-4 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition ${selectedScreeningPreset === "__other__" ? "border-blue-500 bg-blue-50" : "border-gray-300"}`}
                          />
